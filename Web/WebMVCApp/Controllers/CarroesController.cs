...
namespace WebMVCApp.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Placa,Ativo,UsuInc,UsuAlt,DatInc,DatAlt")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Placa,Ativo,UsuInc,UsuAlt,DatInc,DatAlt")] Carro carro)
        {
            if (ModelState.IsValid)
            {
